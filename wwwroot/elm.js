...
var _user$project$Types$Sensor = F6(
	function (a, b, c, d, e, f) {
		return {id: a, kind: b, freq: c, on: d, vals: e, historySize: f};
	});
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {message: a, history: b, historySize: c, sensors: d};
	});
var _user$project$Types$ToggleAll = {ctor: 'ToggleAll'};
var _user$project$Types$ToggleSensor = function (a) {
	return {ctor: 'ToggleSensor', _0: a};
};
var _user$project$Types$GotSensors = function (a) {
	return {ctor: 'GotSensors', _0: a};
};
var _user$project$Types$ChangeMessage = function (a) {
...
var _user$project$Types$OnValue = F2(
	function (a, b) {
		return {ctor: 'OnValue', _0: a, _1: b};
	});

var _user$project$Api$viewRemote = F2(
	function (fn, webData) {
		var _p0 = webData;
		switch (_p0.ctor) {
			case 'Success':
...
var _user$project$Api$dispatchValue = function (s) {
	var _p1 = A2(_elm_lang$core$String$split, ':', s);
	if (((_p1.ctor === '::') && (_p1._1.ctor === '::')) && (_p1._1._1.ctor === '[]')) {
		return A2(_user$project$Types$OnValue, _p1._0, _p1._1._0);
	} else {
		return _user$project$Types$Message(
			A2(_elm_lang$core$Basics_ops['++'], 'Error: ', s));
	}
};
var _user$project$Api$sensorDecoder = A2(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'id',
						_elm_lang$core$Json_Decode$string,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$Sensor)))))));
var _user$project$Api$fetchSensors = A2(
	_lukewestby$elm_http_builder$HttpBuilder$send,
	_user$project$Types$GotSensors,
	_lukewestby$elm_http_builder$HttpBuilder$withCredentials(
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(
				_elm_lang$core$Json_Decode$list(_user$project$Api$sensorDecoder)),
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withTimeout,
				3 * _elm_lang$core$Time$second,
				_lukewestby$elm_http_builder$HttpBuilder$get('/sensors')))));
var _user$project$Api$sensorSocketUrl = function (sId) {
	return A2(_elm_lang$core$Basics_ops['++'], 'ws://localhost:5000/sensor/', sId);
};
var _user$project$Api$chatSocketUrl = 'ws://localhost:5000/chat';
var _user$project$Api$sendMessage = function (str) {
	return A2(_elm_lang$websocket$WebSocket$send, _user$project$Api$chatSocketUrl, str);
};
var _user$project$Api$chatSubscription = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$Api$chatSocketUrl, _user$project$Types$Message);
};

var _user$project$Sensor$isOdd = function (n) {
	return _elm_lang$core$Native_Utils.cmp(
		A2(_elm_lang$core$Basics$rem, n, 2),
		0) > 0;
};
var _user$project$Sensor$toTickStyle = function (_p0) {
	var _p1 = _p0;
	return _user$project$Sensor$isOdd(_p1.index) ? {
		ctor: '::',
...
var _user$project$Sensor$toLabelStyle = function (_p2) {
	var _p3 = _p2;
	return _user$project$Sensor$isOdd(_p3.index) ? {ctor: '[]'} : {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Label$stroke('#969696'),
		_1: {ctor: '[]'}
	};
};
var _user$project$Sensor$pinkStroke = '#441232';
var _user$project$Sensor$plotSize = {ctor: '_Tuple2', _0: 600, _1: 100};
var _user$project$Sensor$viewPlot = F2(
	function (model, sensor) {
		var data = A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, v) {
			...
			A2(_elm_lang$core$List$take, model.historySize, sensor.vals));
		return A2(
			_terezka$elm_plot$Plot$plot,
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot$size(_user$project$Sensor$plotSize),
				_1: {
					ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Line$stroke(_user$project$Sensor$pinkStroke),
						_1: {
							ctor: '::',
					...
					_0: _terezka$elm_plot$Plot$xAxis(
						{
							...
							_0: _terezka$elm_plot$Plot_Axis$line(
								{
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Line$stroke('#000000'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Axis$tick(
									{
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Tick$viewDynamic(_user$project$Sensor$toTickStyle),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Axis$label(
										{
											ctor: '::',
											_0: _terezka$elm_plot$Plot_Label$viewDynamic(_user$project$Sensor$toLabelStyle),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Sensor$viewError = function (err) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Sensor_ops = _user$project$Sensor_ops || {};
_user$project$Sensor_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Sensor$sensorContainerStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: A2(_user$project$Sensor_ops['=>'], 'border', '1px solid black'),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Sensor_ops['=>'], 'padding', '20px'),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Sensor_ops['=>'], 'margin-top', '20px'),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Sensor$infoRow = F2(
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_user$project$Sensor_ops['=>'], 'flex', 'auto'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _user$project$Sensor$viewInfo = function (sensor) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A2(_user$project$Sensor$infoRow, 'Kind', sensor.kind),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Sensor$infoRow,
					'Id',
					A2(_elm_lang$core$String$left, 10, sensor.id)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Sensor$infoRow,
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(sensor.freq),
							' Hz')),
					_1: {
						ctor: '::',
						_0: A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Maybe$map,
									_elm_lang$core$Basics$toString,
									_elm_lang$core$List$head(sensor.vals)))),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Sensor$viewSensor = F2(
	function (model, sensor) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Sensor$sensorContainerStyle,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Types$ToggleSensor(sensor.id)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: A2(_user$project$Sensor_ops['=>'], 'display', 'flex'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_user$project$Sensor$viewPlot, model, sensor),
							_1: {
								ctor: '::',
								_0: _user$project$Sensor$viewInfo(sensor),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Sensor$viewSensors = F2(
	function (model, arr) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(
				_elm_lang$core$List$map,
				_user$project$Sensor$viewSensor(model),
				A2(
					...
					A2(
						_elm_lang$core$List$map,
						_elm_lang$core$Tuple$second,
						_elm_lang$core$Dict$toList(arr)))));
	});

var _user$project$Main$sensorSubscription = F2(
	function (sId, sensor) {
		return sensor.on ? A2(
			_elm_lang$websocket$WebSocket$listen,
			_user$project$Api$sensorSocketUrl(sId),
			_user$project$Types$OnValue(sId)) : _elm_lang$core$Platform_Sub$none;
	});
var _user$project$Main$addValue = F4(
	function (val, id, key, s) {
		return _elm_lang$core$Native_Utils.eq(key, id) ? _elm_lang$core$Native_Utils.update(
			s,
			{
				vals: A2(
					_elm_lang$core$List$take,
					s.historySize,
					{ctor: '::', _0: val, _1: s.vals})
			}) : s;
	});
var _user$project$Main$toggleSensor = F3(
	function (id, key, s) {
		return _elm_lang$core$Native_Utils.eq(key, id) ? _elm_lang$core$Native_Utils.update(
			s,
			{on: !s.on}) : s;
	});
var _user$project$Main$updateSensors = F3(
	function (id, fn, webData) {
		return A2(
			_krisajenkins$remotedata$RemoteData$map,
			_elm_lang$core$Dict$map(
				fn(id)),
...
var _user$project$Main$getSensors = function (model) {
	var _p0 = model.sensors;
	if (_p0.ctor === 'Success') {
		return _p0._0;
	} else {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Api$chatSubscription(model),
			_1: A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Tuple$second,
				_elm_lang$core$Dict$toList(
					A2(
						_elm_lang$core$Dict$map,
						_user$project$Main$sensorSubscription,
						_user$project$Main$getSensors(model))))
		});
};
var _user$project$Main$simpleHandler = F2(
	function (str, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				history: A2(
					_elm_lang$core$List$take,
					model.historySize,
					{ctor: '::', _0: str, _1: model.history})
			});
	});
var _user$project$Main$floatValueHandler = F3(
	function (sId, str, model) {
		...
		if (_p1.ctor === 'Ok') {
			return _elm_lang$core$Native_Utils.update(
				...
				{
					sensors: A3(
						_user$project$Main$updateSensors,
						sId,
						_user$project$Main$addValue(_p1._0),
						model.sensors)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					history: {
						...
						_0: A2(
							_elm_lang$core$Basics_ops['++'],
							'could not convert ',
							A2(_elm_lang$core$Basics_ops['++'], str, ' to float')),
						_1: model.history
					}
				});
		}
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'OnValue':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A3(_user$project$Main$floatValueHandler, _p2._0, _p2._1, model),
					{ctor: '[]'});
			case 'Message':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Main$simpleHandler, _p2._0, model),
					{ctor: '[]'});
			case 'ChangeMessage':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'SendMessage':
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Api$sendMessage(model.message),
						_1: {ctor: '[]'}
					});
			case 'GotSensors':
				var _p3 = _p2._0;
				if (_p3.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								sensors: _krisajenkins$remotedata$RemoteData$Success(
									_elm_lang$core$Dict$fromList(
										A2(
											_elm_lang$core$List$map,
											function (s) {
												return {ctor: '_Tuple2', _0: s.id, _1: s};
											},
											_p3._0)))
							}),
						{ctor: '[]'});
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								sensors: _krisajenkins$remotedata$RemoteData$Failure(_p3._0)
							}),
						{ctor: '[]'});
				}
			case 'ToggleSensor':
				...
				if (_p4.ctor === 'Nothing') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								sensors: A3(_user$project$Main$updateSensors, _p5, _user$project$Main$toggleSensor, model.sensors)
							}),
						{ctor: '[]'});
				}
			default:
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							sensors: _krisajenkins$remotedata$RemoteData$Success(updated)
						}),
					{ctor: '[]'});
		}
	});
var _user$project$Main$getSensor = F2(
	function (id, remoteSensors) {
		var _p6 = remoteSensors;
		if (_p6.ctor === 'Success') {
			return A2(_elm_lang$core$Dict$get, id, _p6._0);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$ChangeMessage),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$SendMessage),
						_1: {
							ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$ToggleAll),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Api$viewRemote,
							_user$project$Sensor$viewSensors(model),
							model.sensors),
						_1: {
							ctor: '::',
							_0: A2(
...
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		...
		history: {ctor: '[]'},
		historySize: 50,
		sensors: _krisajenkins$remotedata$RemoteData$Loading
	},
	{
		ctor: '::',
		_0: _user$project$Api$fetchSensors,
		_1: {ctor: '[]'}
	});
